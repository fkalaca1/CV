          ...
          try {
              ...
              if (responceCode == HttpURLConnection.HTTP_OK) {
                  ...
                  for (int i = 0; i < jo_items.length(); i++) {
                      ...
                      Log.e("TAGSFAGS87", knjiga_id); // LOGINFO____________________________________
                      ...
                      Log.e("tags: poslije for petllje", knjiga_naziv);
